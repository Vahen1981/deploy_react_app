...
const UserFinder = () => {
  ...
  return (
    ...
    >
        ...
        {error && (                                     //si es que hay un error, tb puede ser error?
        ...
        {user && (
            <div>
                <Avatar 
                    ...
                    sx={{
                        width: 10 * 2, // 10  8px (theme spacing)
                        height: 10 * 2,
                        margin: "0 auto",
                        marginTop: 2,
                        marginBottom: 2
                ...
                <Typography variant='body1' gutterBottom>Repositorios Públicos: {user.public_repos}</Typography>
            </div>
        )}
    </Paper>
  )
